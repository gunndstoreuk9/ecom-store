...
const PROBLEM_SOLUTIONS = [
  {
    ...
    solution: "تركيبة تَوازُن كتساعد على تحفيز ودعم وظيفة البنكرياس الطبيعية للمساعدة على توازن السكر في الدم.",
  },
  {
    pain: "تعب فالعشية وهبوط فالطاقة بعد الأكل",
    solution: "القرفة والكروم وALA كيدعمو استعمال السكر كطاقة باش نهارك يبقى منظم أكثر.",
  },
  {
...
const PROOF_STAGES = [
  {
    icon: "🍽️",
    title: "بعد الوجبات",
    text: "مكوّنات بحال القرفة والتوت الأبيض مختارة للمساعدة على توازن السكر في الدم بعد الماكلة.",
    point: "مهم للناس اللي كيتقلقو من الإحساس بالثقل أو التعب بعد الوجبات.",
  },
  {
    icon: "⚡",
    title: "الطاقة خلال النهار",
    text: "الكروم والمعادن الداعمة كيساعدو الجسم فاستعمال السكر كطاقة ضمن الروتين اليومي.",
    point: "روتين بسيط للناس اللي بغاو طاقة أوضح وتنظيم أكثر فالنهار.",
  },
  {
    icon: "🍬",
          ...
          <div className="relative z-10 grid gap-5 lg:grid-cols-2 lg:items-start">
            ...
            <div className="space-y-4 text-right lg:col-start-1 lg:row-start-1">
              ...
              <p className="text-base font-semibold leading-relaxed text-[#344054] md:text-lg">
                {HERO_PRODUCT.nameAr} مركّب أمريكي بـ20 مكوّن نشط لتحفيز ودعم وظيفة البنكرياس الطبيعية والمساعدة على توازن السكر في الدم.
              </p>
          ...
          <div className="mb-10 grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
            <div>
              ...
              <h2 className="max-w-3xl text-3xl font-black leading-tight text-[#102033] md:text-5xl">
                ماشي غير كلام تسويقي: تركيبة موجّهة لدعم وظيفة البنكرياس الطبيعية وتوازن السكر في الدم
              </h2>
              <p className="mt-4 max-w-2xl text-base font-semibold leading-8 text-[#667085]">
                الفكرة بسيطة ومفهومة للعميل المغربي: مكوّنات مختارة بحال القرفة، الكروم والتوت الأبيض للمساعدة على توازن السكر بعد الأكل، دعم الطاقة، والتحكم أكثر فالرغبة فالحلويات.
              </p>
            </div>
        ...
        <div className="container-main">
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            ...
            <div>
              ...
              <p className="mt-3 text-[#667085]">تركيبة مدروسة — كل مكون له دور محدد في دعم وظيفة البنكرياس الطبيعية والمساعدة على توازن السكر في الدم.</p>
